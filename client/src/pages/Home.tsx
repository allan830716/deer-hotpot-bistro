...
function BrandPivotSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // 金色標籤
      gsap.fromTo(".bp-label",
        { y: 24, opacity: 0 },
        { y: 0, opacity: 1, duration: 1, ease: "power3.out",
          scrollTrigger: { trigger: ".bp-label", start: "top 85%", toggleActions: "play none none reverse" }
        }
      );
      // 主標題每行錯開
      gsap.fromTo(".bp-title-line",
        { y: 40, opacity: 0 },
        { y: 0, opacity: 1, duration: 1.2, ease: "power3.out", stagger: 0.15,
          scrollTrigger: { trigger: ".bp-title-line", start: "top 82%", toggleActions: "play none none reverse" }
        }
      );
      // 金線從左展開
      gsap.fromTo(".bp-gold-line",
        { scaleX: 0, transformOrigin: "left center" },
        { scaleX: 1, duration: 1.4, ease: "power3.inOut",
          scrollTrigger: { trigger: ".bp-gold-line", start: "top 85%", toggleActions: "play none none reverse" }
        }
      );
      // 副文字
      gsap.fromTo(".bp-desc",
        ...
        { y: 0, opacity: 1, duration: 1, ease: "power2.out", delay: 0.3,
          scrollTrigger: { trigger: ".bp-desc", start: "top 85%", toggleActions: "play none none reverse" }
        }
      );
    }, sectionRef);
    return () => ctx.revert();
  ...
  return (
    <section ref={sectionRef} className="section-lg" style={{ backgroundColor: "var(--deer-bg)" }}>
      <div className="container-narrow text-center">
        <p className="bp-label font-label mb-8" style={{ color: "var(--deer-gold)" }}>
        ...
        <h2 style={{ fontFamily: "'Noto Serif TC', serif", fontWeight: 200, fontSize: "clamp(1.5rem, 3vw, 2.25rem)", lineHeight: 1.7, color: "var(--deer-text)", letterSpacing: "0.08em" }}>
          <span className="bp-title-line" style={{ display: "block" }}>{t("home.philosophy.title1")}</span>
          <span className="bp-title-line" style={{ display: "block", marginTop: "0.5em" }}>&nbsp;</span>
          <span className="bp-title-line" style={{ display: "block" }}>{t("home.philosophy.title2")}</span>
          <span className="bp-title-line" style={{ display: "block" }}>{t("home.philosophy.title3")}</span>
        </h2>
        {/* 金線：用 div 包住讓 scaleX 動畫正確 */}
        <div style={{ display: "flex", justifyContent: "center", margin: "2rem 0" }}>
          <div className="bp-gold-line" style={{ width: "32px", height: "1px", backgroundColor: "var(--deer-gold)" }} />
        </div>
        <p className="bp-desc" style={{ color: "var(--deer-sub)", fontSize: "0.875rem", lineHeight: 2, letterSpacing: "0.06em", whiteSpace: "pre-line" }}>
...
function getCores(t: (key: string) => string) {
  return [
    { img: SOUP_IMG,    zh: t("home.cores.soup.zh"),    en: t("home.cores.soup.en"),    line1: t("home.cores.soup.subtitle2"),    desc: t("home.cores.soup.desc2"),    from: "left"  },
    { img: MEAT_IMG,    zh: t("home.cores.meat.zh"),    en: t("home.cores.meat.en"),    line1: t("home.cores.meat.subtitle2"),    desc: t("home.cores.meat.desc2"),    from: "bottom" },
    { img: DESSERT_IMG, zh: t("home.cores.dessert.zh"), en: t("home.cores.dessert.en"), line1: t("home.cores.dessert.subtitle2"), desc: t("home.cores.dessert.desc2"), from: "right" },
  ];
}
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".core-header",
        { y: 30, opacity: 0 },
        { y: 0, opacity: 1, duration: 1, ease: "power3.out",
          scrollTrigger: { trigger: ".core-header", start: "top 82%", toggleActions: "play none none reverse" }
        }
      );
      // 三張卡片依序滑入
      gsap.utils.toArray<HTMLElement>(".core-card").forEach((card, i) => {
        const fromX = i === 0 ? -80 : i === 2 ? 80 : 0;
        const fromY = i === 1 ? 60 : 0;
        gsap.fromTo(card,
          { x: fromX, y: fromY, opacity: 0 },
          { x: 0, y: 0, opacity: 1, duration: 1.3, ease: "power3.out", delay: i * 0.15,
  ...
  return (
    <section ref={sectionRef} className="section" style={{ backgroundColor: "var(--deer-bg-dark)" }}>
      <div className="container">
        <div className="core-header text-center mb-16">
...
type CoreItem = { img: string; zh: string; en: string; line1: string; desc: string; from: string };
function CoreCard({ img, zh, en, line1, desc }: CoreItem) {
  return (
...
function NarrativeSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".narr-header",
        { y: 30, opacity: 0 },
        { y: 0, opacity: 1, duration: 1, ease: "power3.out",
          scrollTrigger: { trigger: ".narr-header", start: "top 82%", toggleActions: "play none none reverse" }
        }
      );
      // 四個步驟依序淡入
      ...
      gsap.fromTo(".narr-cta",
        ...
        { y: 0, opacity: 1, duration: 1, ease: "power2.out",
          scrollTrigger: { trigger: ".narr-cta", start: "top 88%", toggleActions: "play none none reverse" }
        }
      );
    }, sectionRef);
    return () => ctx.revert();
  ...
  return (
    <section ref={sectionRef} className="section-lg" style={{ backgroundColor: "var(--deer-dark)" }}>
      <div className="container">
        <div className="narr-header text-center mb-20">
        ...
        <div className="narr-cta" style={{ textAlign: "center", marginTop: "4rem", paddingTop: "3rem", borderTop: "1px solid rgba(197,151,109,0.15)" }}>
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.to(".space-parallax-img",
        { yPercent: -12, ease: "none",
          scrollTrigger: { trigger: ".space-parallax-img", start: "top bottom", end: "bottom top", scrub: true }
        }
      );
      // 文字淡入
      gsap.fromTo(".space-text",
        ...
        { y: 0, opacity: 1, duration: 1.3, ease: "power3.out",
          scrollTrigger: { trigger: ".space-text", start: "top 80%", toggleActions: "play none none reverse" }
        }
      );
    }, sectionRef);
    return () => ctx.revert();
  ...
  return (
    <section ref={sectionRef} style={{ position: "relative", overflow: "hidden" }}>
      <div style={{ position: "relative", height: "80vh", minHeight: "500px", overflow: "hidden" }}>
        ...
        <div className="space-text" style={{ position: "absolute", bottom: "4rem", left: "50%", transform: "translateX(-50%)", textAlign: "center", width: "100%", padding: "0 2rem" }}>
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".trust-block",
        ...
        { y: 0, opacity: 1, duration: 1.2, ease: "power3.out",
          scrollTrigger: { trigger: ".trust-block", start: "top 80%", toggleActions: "play none none reverse" }
        }
      );
      // 評分數字計數動畫
      ...
      if (ratingEl) {
        gsap.fromTo({ val: 0 }, { val: rating },
          { duration: 2.2, ease: "power2.out",
            ...
            scrollTrigger: { trigger: ratingEl, start: "top 80%", toggleActions: "play none none none" }
          }
        );
      }
      // 星星依序點亮
      gsap.utils.toArray<HTMLElement>(".trust-star").forEach((star, i) => {
        gsap.fromTo(star,
          { scale: 0.5, opacity: 0 },
          { scale: 1, opacity: 1, duration: 0.5, ease: "back.out(2)", delay: i * 0.12,
            scrollTrigger: { trigger: ".trust-stars", start: "top 82%", toggleActions: "play none none reverse" }
          }
        );
      });
      // 獎項列表依序淡入
      gsap.utils.toArray<HTMLElement>(".trust-award").forEach((award, i) => {
        gsap.fromTo(award,
          { x: -30, opacity: 0 },
          { x: 0, opacity: 1, duration: 0.9, ease: "power3.out", delay: i * 0.15,
            scrollTrigger: { trigger: award, start: "top 85%", toggleActions: "play none none reverse" }
          }
        );
      });
    }, sectionRef);
        ...
        <div className="trust-block">
          ...
          <div className="trust-stars" style={{ display: "flex", justifyContent: "center", gap: "0.375rem", marginBottom: "1.5rem" }}>
            {[1, 2, 3, 4, 5].map((star) => {
              ...
              return (
                <span key={star} className="trust-star" style={{ position: "relative", display: "inline-block", fontSize: "1.25rem", color: "var(--deer-muted)" }}>
                  ★
                  {(filled || half) && (
          ...
          <div style={{ marginTop: "3rem", borderTop: "1px solid rgba(197,151,109,0.12)", paddingTop: "2.5rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
              {[
                ...
                <div key={i} className="trust-award">
...
function CTASection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // 頂部線條從中心向兩側展開
      gsap.fromTo(".cta-top-line",
        { scaleX: 0, transformOrigin: "center center" },
        { scaleX: 1, duration: 1.4, ease: "power3.inOut",
          scrollTrigger: { trigger: ".cta-top-line", start: "top 85%", toggleActions: "play none none reverse" }
        }
      );
      // 標籤
      gsap.fromTo(".cta-label",
        ...
        { y: 0, opacity: 1, duration: 0.9, ease: "power3.out", delay: 0.3,
          scrollTrigger: { trigger: ".cta-label", start: "top 85%", toggleActions: "play none none reverse" }
        }
      );
      // 主標題
      gsap.fromTo(".cta-title",
        ...
        { y: 0, opacity: 1, duration: 1.2, ease: "power3.out", delay: 0.5,
          scrollTrigger: { trigger: ".cta-title", start: "top 85%", toggleActions: "play none none reverse" }
        }
      );
      // 副標題
      gsap.fromTo(".cta-subtitle",
        ...
        { y: 0, opacity: 1, duration: 1, ease: "power2.out", delay: 0.7,
          scrollTrigger: { trigger: ".cta-subtitle", start: "top 88%", toggleActions: "play none none reverse" }
        }
      );
      // 按鈕從下浮現
      gsap.fromTo(".cta-btn",
        { y: 30, opacity: 0, scale: 0.95 },
        { y: 0, opacity: 1, scale: 1, duration: 1, ease: "back.out(1.5)", delay: 0.9,
  ...
  return (
    <section ref={sectionRef} className="section-lg" style={{ backgroundColor: "var(--deer-dark)" }}>
      <div className="container-narrow text-center">
        {/* 頂部裝飾線 */}
        <div className="cta-top-line" style={{ width: "100%", height: "1px", backgroundColor: "rgba(197,151,109,0.2)", marginBottom: "4rem" }} />
        <p className="cta-label font-label mb-8" style={{ color: "rgba(197,151,109,0.7)" }}>{t("home.cta.label")}</p>
        <h2 className="cta-title" style={{ fontFamily: "'Noto Serif TC', serif", fontWeight: 200, fontSize: "clamp(1.75rem, 4vw, 3rem)", color: "var(--deer-dark-text)", letterSpacing: "0.1em", marginBottom: "1.5rem" }}>
          {t("home.cta.title")}
        </h2>
        <p className="cta-subtitle" style={{ fontSize: "0.875rem", color: "rgba(240,233,223,0.45)", lineHeight: 2, marginBottom: "3rem", letterSpacing: "0.06em" }}>
          {t("home.cta.subtitle")}
        </p>
        <a className="cta-btn" href="https://inline.app/booking/-LnGxVQiLowRUUBg2dlS:inline-live-1/-LnGxVUeNglvFM_8Rz2a?language=zh-tw" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block" }}>
