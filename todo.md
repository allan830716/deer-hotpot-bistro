...
- [x] 交通頁面移除 Section 8 Google Maps iframe（資訊已足夠）
- [x] 重製插畫地圖 SVG（修正各地點正確相對位置）
- [x] 頁尾加入「交通與停車」引導區塊（連結至 /transport）

## 第十六批更新（2026-04-24）

- [x] 漢堡選單：在「交通與停車」連結下方的空白區塊加入「↗ 導航至餐廳」快速按鈕

## 第十七批更新（2026-04-24）

- [x] 漢堡選單：移除剛加的「導航至餐廳」按鈕
- [x] 導覽列將「CRÈM蛋糕上桌預訂」移至較後位置（移出 NAV_LINKS）
- [x] 漢堡選單底部加入「CRÈM 蛋糕上桌預訂」CTA 按鈕（點擊跳轉 /crem）

## 第十八批更新（2026-04-24）

- [x] 根據 Google Maps 實際座標重製交通示意圖 SVG（修正所有地點相對位置，以 Google Maps 北方向為準）

## 第十九批更新（2026-04-24）

- [x] 停車場卡片第二張：改為「係尌停車基隆路二場」（基隆路一段176巷1號）→ 實際字元為「係尌停車基隆路二場」
- [x] 停車場卡片第三張：改為「臺北文創大樓收費停車場」（信義區菸廠路88號）
- [x] 同步更新導航連結、決策引導文字、相關步行時間

## 第二十批更新（2026-04-24）

- [x] 根據 Google Maps 截圖精確位置重製交通示意圖 SVG v4（路線依 Google Maps 設定）
- [x] 同步更新停車場步行時間：松山高中3分、係尌2分、臺北文創大樓8分
- [x] 同步更新公車站步行時間：聯合報字2分、市府轉運站5分
- [x] 同步更新捷運步行時間：市政府站5分

## 第二十一批更新（2026-04-24）

- [x] 根據用戶標注截圖精確重製 SVG v5（依截圖像素座標計算各地點位置）
- [x] 新增地標：臺北大巨蛋、松菸文創園區
- [x] 使用初衷小鹿品牌色系（暖棕金、深褐、霧金）

## 第二十二批更新（2026-04-24）

- [x] 地圖改為互動 React SVG 元件：修正文字框重疊問題
